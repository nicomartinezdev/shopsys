            ...
            'data' => [
                'CreateOrder' => [
                    ...
                    'totalPrice' => [
                        ...
                        'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('102579.75'),
                        'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('21531.25'),
                    ],
        ...
        return [
            ...
            1 => [
                ...
                'totalPrice' => [
                    ...
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('10000.00'),
                    'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('2100.00'),
                ],
                'quantity' => 100,
                'vatRate' => '21.0000',
                'unit' => t('pcs', [], 'dataFixtures', $firstDomainLocale),
            ...
            2 => [
                ...
                'unitPrice' => [
                    ...
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('6199.00'),
                    'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('1301.75'),
                ],
                'totalPrice' => [
                    'priceWithVat' => $this->getPriceWithVatConvertedToDomainDefaultCurrency('7500.75'),
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('6199.00'),
            ...
            3 => [
                ...
                'unitPrice' => [
                    ...
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('6399.00'),
                    'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('1343.75'),
                ],
                'totalPrice' => [
                    'priceWithVat' => $this->getPriceWithVatConvertedToDomainDefaultCurrency('15485.50'),
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('12798.00'),
                    'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('2687.50'),
                ],
                'quantity' => 2,
                'vatRate' => '21.0000',
                'unit' => t('pcs', [], 'dataFixtures', $firstDomainLocale),
            ...
            4 => [
                ...
                'totalPrice' => [
                    ...
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('19994.75'),
                    'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('4199.00'),
                ],
                'quantity' => 5,
                'vatRate' => '21.0000',
                'unit' => t('pcs', [], 'dataFixtures', $firstDomainLocale),
            ...
            5 => [
                ...
                'unitPrice' => [
                    ...
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('8173.50'),
                    'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('1716.50'),
                ],
                'totalPrice' => [
                    'priceWithVat' => $this->getPriceWithVatConvertedToDomainDefaultCurrency('29670.00'),
                    'priceWithoutVat' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('24520.75'),
                    'vatAmount' => $this->getPriceWithoutVatConvertedToDomainDefaultCurrency('5149.25'),
                ],
                'quantity' => 3,
                'vatRate' => '21.0000',
                'unit' => t('pcs', [], 'dataFixtures', $firstDomainLocale),
