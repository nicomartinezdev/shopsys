...
class ProductDataFixture extends AbstractReferenceFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Screen size', [], 'dataFixtures', $locale),
                t('27"', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Technology', [], 'dataFixtures', $locale),
                t('LED', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Resolution', [], 'dataFixtures', $locale),
                t('1920×1080 (Full HD)', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('USB', [], 'dataFixtures', $locale),
                t('Yes', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('HDMI', [], 'dataFixtures', $locale),
                t('Yes', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        ...
        $this->setCategoriesForAllDomains(
            $productData,
            [CategoryDataFixture::CATEGORY_ELECTRONICS, CategoryDataFixture::CATEGORY_TV]
        );
        $productData->categoriesByDomainId[Domain::SECOND_DOMAIN_ID] = [];
        $productData->categoriesByDomainId[Domain::SECOND_DOMAIN_ID][] = $this->persistentReferenceFacade->getReference(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Gaming mouse', [], 'dataFixtures', $locale),
                t('Yes', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Ergonomics', [], 'dataFixtures', $locale),
                t('Right-handed', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Supported OS', [], 'dataFixtures', $locale),
                t('Windows 2000/XP/Vista/7', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Number of buttons', [], 'dataFixtures', $locale),
                t('5', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        $this->setCategoriesForAllDomains(
            $productData,
            [CategoryDataFixture::CATEGORY_ELECTRONICS, CategoryDataFixture::CATEGORY_PC]
        );
        $this->setFlags($productData, []);
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Mobile phone - Apple A7 with 64-bit architecture, 4" Retina Touch display 1136x640, 32GB internal memory, WiFi 802.11a/b/g/n, Bluetooth 4.0, 8 Mpx camera with LED flash, GPS, Fingerprint sensor, iOS 7',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Weight', [], 'dataFixtures', $locale),
                t('112 g', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Dimensions', [], 'dataFixtures', $locale),
                t('123.8x58.6 mm', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Memory card support', [], 'dataFixtures', $locale),
                t('No', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('RAM', [], 'dataFixtures', $locale),
                t('1024 MB', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Number of colors', [], 'dataFixtures', $locale),
                t('16mil.', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Processor frequency', [], 'dataFixtures', $locale),
                t('1.7GHz', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Number of processor cores', [], 'dataFixtures', $locale),
                t('2', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Bluetooth', [], 'dataFixtures', $locale),
                t('Yes', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('GPS module', [], 'dataFixtures', $locale),
                t('No', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        ...
        $this->setFlags(
            $productData,
            [FlagDataFixture::FLAG_NEW_PRODUCT, FlagDataFixture::FLAG_ACTION_PRODUCT, FlagDataFixture::FLAG_TOP_PRODUCT]
        );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Display', [], 'dataFixtures', $locale),
                t('LCD', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Parallel port', [], 'dataFixtures', $locale),
                t('No', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<h2>Canon EH-22L</h2>High quality, elegant, soft, and yet reliably protecting brand case for your Canon digital camera CANON EOS 650D or 700D. Provides protection while traveling from dust, scratches and other negative influences. You also have the camera ready at hand. It fits into the unit with lens 18-55 mm.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Canon EH-22L. High quality, elegant, soft, and yet reliably protecting brand case for your Canon digital camera CANON EOS 650D or 700D. ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Color', [], 'dataFixtures', $locale),
                t('black', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Camera type', [], 'dataFixtures', $locale),
                t('SLR', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Resolution', [], 'dataFixtures', $locale),
                t('9 Mpix', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Power supply', [], 'dataFixtures', $locale),
                t('battery', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Viewfinder type', [], 'dataFixtures', $locale),
                t('optical', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Sensitivity (ISO)', [], 'dataFixtures', $locale),
                t('1800', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Display size', [], 'dataFixtures', $locale),
                t('3“', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Print technology', [], 'dataFixtures', $locale),
                t('inkjet', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Maximum size', [], 'dataFixtures', $locale),
                t('A3', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Print resolution', [], 'dataFixtures', $locale),
                t('4800x1200', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Color printing', [], 'dataFixtures', $locale),
                t('Yes', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Dimensions', [], 'dataFixtures', $locale),
                t('449x304x152 mm', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'media 210MB, 24min., writing speed 24x, slim box',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Media type', [], 'dataFixtures', $locale),
                t('Mini CD-R 8 cm', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Color', [], 'dataFixtures', $locale),
                t('white', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Capacity', [], 'dataFixtures', $locale),
                t('210 MB', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<h2>D-Link DGS-105/E</h2>The switch provides a cost-effective way to create a small network or extend existing ones. Connect not only computers, but also a number of network devices such as IP cameras, network printers and more. The switch is equipped with five Gigabit Ethernet ports with auto-sensing speeds, so you shall always have the best performance. To communicate without delay and smooth video streaming has integrated <strong> QoS optimization </strong> . <br><br> Switch functions quickly and easily without complicated setting. But <strong> consistently low power </strong> detect used ports, and if stopping traffic enters Sleep mode. <strong> Rugged metal body is sufficient for cooling without fan </strong> . Together with its small size you can find a place almost anywhere. Also available is a set of <strong> wall mounting </strong> and it can also protect against theft Kensington.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'The switch provides a cost-effective way to create a small network or extend existing ones. Connect not only computers, but also a number of network devices such as IP cameras, network printers and more.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<h2>Defender SPK-480</h2><strong>Defender SPK 480</strong>, two portable and practical&nbsp;<strong>2" broadband&nbsp;</strong>speakers. They have&nbsp;<strong>4 watt output&nbsp;</strong>and are powered by USB. They\'re made of durable plastic and their&nbsp;compact size is&nbsp;<strong>portable&nbsp;</strong>and easy to fit into any bag or backpack. The speakers connect to notebooks or portable music players via the built-in 3.5 mm jack. Each speaker features its own volume control, and they can be placed near monitors without disturbing image quality due to their magnetic shielding. The silver and black&nbsp;design is simple and modern.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Dimensions', [], 'dataFixtures', $locale),
                t('80x70x70 mm', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Overall performance', [], 'dataFixtures', $locale),
                t('4 W', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        $this->setCategoriesForAllDomains(
            $productData,
            [CategoryDataFixture::CATEGORY_TV, CategoryDataFixture::CATEGORY_PC]
        );
        $productData->categoriesByDomainId[Domain::SECOND_DOMAIN_ID] = [];
        $productData->categoriesByDomainId[Domain::SECOND_DOMAIN_ID][] = $this->persistentReferenceFacade->getReference(
            CategoryDataFixture::CATEGORY_TV
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<h2>DéLonghi ECAM 44.660.B</h2><p>Start the morning with your favorite drink with the DeLonghi ECAM 44.660.B Eletta automatic coffee maker.&nbsp; A built in special hot steam/water jet automatically prepares a thick milk froth for cappuccino and tea. Drip coffee lovers can also press their own coffee.</p><h3>Magic Milk Menu button</h3><p><br>A special function is the Milk Menu button, which gives you a choice of milk-based beverages. In addition to the classic cappuccino, latte macchiato, or Latte, you can prepare rare drinks such as Espresso macchiato and a flat white. For a quick and easy treat, you can prepare hot cocoa or a cup of frothed milk, and the size of the beverage can be adjusted based on the cup.&nbsp;&nbsp;</p>',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'DéLonghi ECAM 44.660.B. Start the morning with your favorite drink with the DeLonghi ECAM 44.660.B Eletta automatic coffee maker',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Pressure', [], 'dataFixtures', $locale),
                t('15 bar', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Water reservoir capacity', [], 'dataFixtures', $locale),
                t('2 l', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Milk reservoir capacity', [], 'dataFixtures', $locale),
                t('600 ml', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Magazine capacity for beans', [], 'dataFixtures', $locale),
                t('400 g', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'This pot holder is used to hold pots. No more burnt kitchen tables!',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Simple Genius Mouse NetScroll 310 offers the most widely used functional elements of a basic ergonomics. It has an optical sensor with a resolution of 800 DPI, which can handle work on a large number of standard surfaces. There are two classic buttons and the third with the paging function wheel. Genius NetScroll 310 is equipped with modern USB interface and finds use in conserving ambidextrous or in an office environment. <br><strong> Specifications: </strong><br><strong> Supported OS: </strong><br> Microsoft Windows 7, Vista, XP, 2003, 2000, 98SE <br> Mac OS 8.6 or later ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Simple Genius Mouse NetScroll 310 offers the most widely used functional elements of a basic ergonomics. It has an optical sensor with a resolution of 800 DPI, which can handle work on a large number of standard surfaces. ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Interface', [], 'dataFixtures', $locale),
                t('Wired', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<h2>GENIUS SP-M120 black</h2><p align="justify"> Sleek and compact stereo speakers in combination of black and metallic surface. Speakers provide basic computer sound system with an output of 2 W RMS. On the front is virtually placed in a large volume control, but not forgotten even the popular headphone jack. <br><strong> Specifications: <br> Performance: <br></strong> 2 x 1 W RMS <br><strong> Frequency Range: </strong> 100 Hz - 20KHz <br><strong> Signal/noise ratio: </strong> 75 db <br><strong> Dimensions: </strong> 50 x 90 mm </p>',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Sleek and compact stereo speakers in combination of black and metallic surface.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('System type', [], 'dataFixtures', $locale),
                t('2.0', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Active/Passive', [], 'dataFixtures', $locale),
                t('Active', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Localization', [], 'dataFixtures', $locale),
                t('Czech', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Element arrangement', [], 'dataFixtures', $locale),
                t('classic', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Enter', [], 'dataFixtures', $locale),
                t('one-slotted', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Print resolution', [], 'dataFixtures', $locale),
                t('2400x600', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Photographer\'s dream. Main camera with 13-megapixel front camera and a 5 megapixel guarantee photos in high definition on each side. Thanks to the built-in tools for editing and sharing can capture moving images in HD and combine the results to show from multiple angles. Incredible design, giant 5,5palcový display with HD resolution, two front stereo speakers, customized channels with real-time information and a quad-core processor - all combine to form one of the best smartphones in the world.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Photographer\'s dream. Main camera with 13-megapixel front camera and a 5 megapixel guarantee photos in high definition on each side. Thanks to the built-in tools for editing and sharing can capture moving images in HD and combine the results to show from multiple angles.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Display Size', [], 'dataFixtures', $locale),
                t('5.5"', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Display type', [], 'dataFixtures', $locale),
                t('Super LCD', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Resolution of rear camera', [], 'dataFixtures', $locale),
                t('13 Mpx', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Pages count', [], 'dataFixtures', $locale),
                t('55', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Weight', [], 'dataFixtures', $locale),
                t('50 g', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Cover', [], 'dataFixtures', $locale),
                t('hardcover', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'Book scoring system and traffic regulations',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'New driving rules and tips just for you!',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'Book Computer for Dummies Digital Photography II',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Discover the secret of people with us.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Collection of classical Czech fairy tales.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Have you ever experienced an accident and didn\'t know how to react? Or are you going to? This book is just for you!',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Mobile phone 4.7" 720x1280, procesor 1,5GHz, internal memory 16GB, camera 8mpx, GPS, WiFi, Bluetooth, 3G, FM, microSD, micro USB, Android 4.0',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Practical and stylish optical mouse ideal for everyday office use.With its ergonomic shape fits perfect and is suitable for left and for right-handers.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Toilet paper with Euro pictures. Even you can feel rich now!',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Cyklocomputer – cyklonavigation with preset maps, color display 3", training programmes, WiFi',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Toner for MC861/ 851, 7000 pages',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Dimensions', [], 'dataFixtures', $locale),
                t('426x306x145 mm', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'OLYMPUS ME-34 Compact directional microphone suitable for recording lectures',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Digital Voice Reco.rder Olympus VN-733PC is profiled primarily intuitive operation and long battery life . Its user offers 4 gigabytes internal memory and a new slot for microSD cards. O capacity certainly will not be a shortage in power saving mode, LP handle record up to 1600 hours of recording',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Digital Voice Reco.rder Olympus VN-733PC is profiled primarily intuitive operation and long battery lif.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Digital Camera CMOS 16 megapixel, 24x zoom, 3.0 "LCD, Li-Ion, FullHD video, histogram, HDR, optical stabilizer, SD/SDHC/SDXC, face detection, USB',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Digital Camera - Waterproof, shockproof, freezeproof, 16.1 Mpx CCD, 4x zoom (29-108 mm), 2.7" LCD display, Li-Ion, HD video, SD/SDHC/SDXC, time lapse recording, stabilizer',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Red and green paper glasses for watching ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'This luminiscent tape might prevent you from dying.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Mouse game, 8200dpi laser sensor, 7 programmable buttons + 2D wheel 12000fps, 1ms response, EasyShift, USB, LED backlight, Turbo Core V2, Black ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Mobile phone 4.5 "800x480, processor, Quad-Core 1.2GHz, RAM 768 megabytes internal memory of 4GB, microSD up to 64GB, 5 megapixel camera, GPS, WiFi, Bluetooth 4.0, NFC, 3G, microUSB, Li-Ion 2000 mAh, Android 4.4',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Mobile phone 4.5 "800x480, processor, Quad-Core 1.2GHz, RAM 768 megabytes internal memory of 4GB',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Resolution', [], 'dataFixtures', $locale),
                t('800 × 480 px', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Annual energy consumption ', [], 'dataFixtures', $locale),
                t('250 kWh/year', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Annual energy consumption ', [], 'dataFixtures', $locale),
                t('275 kWh/year', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Television SMART 3D LED, 189 cm diagonal, CMR 1000 4K Ultra HD 3840x2160, DVB-S2 / T2 / C, 4x HDMI, 3x USB, CI +, LAN, WiFi, DLNA, MHL, HbbTV, Tizen OS, energ. Class A ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Television SMART 3D LED, 189 cm diagonal.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Energy efficiency class', [], 'dataFixtures', $locale),
                t('A', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'DVB-T Receiver HD - MPEG4, MPEG2, USB recording, timeshift, EPG, HDMI 1.3, USB, SCART, coaxial output, power antenna 5V/50mA ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'DVB-T Receiver HD - MPEG4, MPEG2, USB recording, timeshift',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Tuner', [], 'dataFixtures', $locale),
                t('DVB-T', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Recording on', [], 'dataFixtures', $locale),
                t('flash disk', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Multimedia', [], 'dataFixtures', $locale),
                t('Video', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'HQ speakers from well known brand.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Ear Coupling', [], 'dataFixtures', $locale),
                t('Circumaural', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Construction', [], 'dataFixtures', $locale),
                t('Open', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Fold-up', [], 'dataFixtures', $locale),
                t('Other', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Determination', [], 'dataFixtures', $locale),
                t('Home Listening', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Cap with air conditioning, convenient for hot days.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Digital Camera CMOS Exmor R1 20.2 megapixel, 3.6x zoom (28-100 mm F1.8), Full HD video (1920 x 1080) 50p, 3 "LCD, Li-Ion, MS DUO + \u200b\u200bSD/SDHC/SDXC, Face Detection, Intelligent stabilizer ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Digital Camera CMOS Exmor R1 20.2 megapixel, 3.6x zoom',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Mobile phone 4.6 "1280x720, Qualcomm MSM8960Pro 1.7 GHz, 1GB RAM, 8GB 8MPx camera, GPS, WiFi, Bluetooth, FM, micro USB, Android 4.1',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Mobile phone 4.6 "1280x720, Qualcomm MSM8960Pro 1.7 GHz',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Fluorescent green laces. Visible at any condition.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'VERBATIM 1TB external HDD 2,5" USB 3.0 GT SuperSpeed red',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                '<p>This product is not an independently functional unit and may require professional installation.</p>',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Speakers 2 x 3W RMS, 2.0 stereo, portable, volume control, frequency range of 150Hz-20kHz, sensitivity 80dB, 4Ohm impedance, power supply via USB, 3.5 mm audio jack, dimensions 85x85x107mm, weight 550 g',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Speakers 2 x 3W RMS, 2.0 stereo, portable, volume control, frequency range of 150Hz-20kHz, sensitivity 80dB',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Resolution', [], 'dataFixtures', $locale),
                t('1366×768 (HD Ready)', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
            $this->addParameterTranslations(
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'TV Cinema 3D LED SMART diagonal 119 cm, 700 MCI, 1920x1080 Full HD, DVB-S / S2 / T / T2 / C, 3x HDMI, 3x USB, CI, SCART, MHL, LAN, HbbTV, WiFi, Miracast / WiDi, WebOS, Web browser, Dual Core, 2 pieces 3D glasses AG-F310, magical driver energ. Class A +',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'TV Cinema 3D LED SMART diagonal 119 cm, 700 MCI, 1920x1080 Full HD',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Television LED, diagonal 82 cm, 1366x768, DVB-T/C MPEG4 tuner, 2x HDMI, USB, SCART, VGA, headphone jack, USB/HDD recording, hotel mode, Energ. Class A ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Television LED, diagonal 82 cm, 1366x768, DVB-T/C MPEG4 tuner',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Television monitor LED 16: 9, 5M: 1, 250cd/m2, 9.5ms',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Watch broadcast in stunning Full HD, while at the same stylish devices work.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'The TV monitor PLS LED, 1000:1, 5ms, 1920x1080, tuner DVB-T/C, PiP +, 2x HDMI, MHL, USB, CI, Scart, 2x 5W speakers, remote control',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Xtreamer SW4 is all-encompassing amusement system, bringing fun to your TV. Games, movies and many more functions in HD quality',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Xtreamer SW4 is all-encompassing amusement system, bringing fun to your TV. Games, movies and many more functions',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'TV SMART LED TV, 147 cm diagonal, 4K Ultra HD 3840x2160 4K upscaler, DVB-S2 / T2 / C, H.265, 3x HDMI, 3x USB, Scart, CI +, LAN, WiFi, Miracast, DLNA, MHL, HbbTV, Web browser, webOS 2.0, 2x10W speakers, magical MR15 driver, energ. Class A +',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Television LED, diagonal 82 cm, 1366x768, DVB-T/C MPEG4 tuner, 2x HDMI',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Television monitor IPS, 16: 9, 5M: 1, 200cd/m2, 5ms GTG, FullHD 1920x1080',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Xtreamer SW5 is all-encompassing amusement system, bringing fun to your TV. Games, movies and many more functions in HD quality',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Xtreamer SW5 is all-encompassing amusement system, bringing fun to your TV. Games, movies and many more functions',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Prime flour for creating your own cake. Now with special discount.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Well known USB cable with A and micro B connectors.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            ...
            $this->addParameterTranslations(
                $parameterTranslations,
                t('Connectors', [], 'dataFixtures', $locale),
                t('A and micro B', [], 'dataFixtures', $locale),
                $locale,
                $i
            );
        }
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'TV LED, 100Hz, diagonal 32 inches 100Hz, Full HD 1920 x 1080, DVB-T / C, 2x HDMI, USB, CI +, VGA, SCART, speakers 16W, energy. Class A + ',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<h2>Nikon EH-22L</h2> High quality, elegant, soft, and yet reliably protecting brand case for your Nikon digital camera CANON EOS 650D or 700D. Provides protection while traveling from dust, scratches and other negative influences. You also have the camera ready at hand. It fits into the unit with lens 18-55 mm.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'High quality, elegant, soft, and yet reliably protecting brand case for your Canon digital camera CANON EOS 650D or 700D.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Canon EOS 700D + EF-S 18-55 mm + 75-300 mm DC III DC III Quality digital camera with CMOS sensor with a resolution of 18 megapixels',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Digital Camera Nikon VH-520 16 megapixel, 24x zoom, 3.0 "LCD, Li-Ion, FullHD video, histogram, HDR, optical stabilizer, SD/SDHC/SDXC, face detection, USB',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Digital Camera Nikon VH-520 16 megapixel, 24x zoom, 3.0 "LCD, Li-Ion, FullHD video',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Digital Camera - Waterproof, shockproof, freezeproof, 16.1 Mpx CCD',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Quality digital camera with CMOS sensor with a resolution of 18 megapixels',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Digital Camera CMOS 16 megapixel, 24x zoom, 3.0 "LCD, Li-Ion, FullHD video, histogram, HDR',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<ul><li> Type nozzles: Universal </li><li> Diameter: 32 mm </li><li> Turbobrush Big </li></ul>',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Type nozzles: Universal. Diameter: 32 mm. Turbobrush: Big.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'NS-9020 Limpio/Clipper/Nino replacement paper bags for VP902/3/9010',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Limpio VP 9020/21, Clipper VP and VP 913_ 903_, Nino VP 9010 Packaging: 5 pieces of bags + input and output filter.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Limpio VP 9020/21',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'NS-9030 Clipper replacement paper bags for VP-903/913',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Clipper 9030/31/32/33 VP and VP 9130/31/32. Packaging: 5 pieces of bags + input and output filter.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Clipper 9030/31/32/33 VP and VP 9130/31/32',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'NS-9040 Jumbo replacement paper bags for VP-9040',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Jumbo VP 9,041th Package: 5 pieces of bags + input and output filter.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Jumbo VP 9',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'NS-9710 Prominent replacement paper bags for VP-9711/12/13',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Prominent VP 9711/12/13. Packaging: 5 pieces of bags + input and output filter.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT Prominent VP 9711/12/13',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                'Tube type: Universal. Diameter: 32mm.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<p> The minimum space requirements excels sub-mounting range hood OPP-2060th Suitable for very small kitchens. Metal buttons provide ease of use and precise adjustment of the corresponding stage performance. </p> <br /> <br /> <h2> Reasons to choose just the sub-mounting range hood Concept OPP-2060: </h2> <br /> <br /> <ol> <li> Performance is the most important parameter hoods and should be at least equal to ten times the volume of the room. The sub-mounting range hood brand Concept OPP-2060 will surprise performance <strong> 186 m3 per hour </strong>. </li><li> Very practical is the ability to select <strong> 4 Ways exhaust </strong>. </li></ol> Model OPP-2060 is equipped with a practical <strong> metal grease filter </strong>, its maintenance is very easy and unlimited lifespan. If you can not pay out of steam, you can choose instead of exhaust classic <strong> recirculation system </strong> using a carbon filter, which can be bought.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                'The minimum space requirements excels sub-mounting range hood OPP-2060th',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'OPK44xx carbon filter / OPK-5690 / OPK5790 / OPO55xx',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                '295 x 240 x 15 mm <br /> cartridge with active carbon',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'Metal grease filter OPK-5660 / OPK-5760 / OPK-6690',
                [],
                'dataFixtures',
                $locale
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'Deep baking sheet ETV-2560/2860/2960 / 3160bc',
                [],
                'dataFixtures',
                $locale
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '<h2> Specifications: </h2> <ul> <li> Height: 140 mm </li> <li> Width: 600 mm </li> <li> Depth: 470 mm </li> <li> Accessories: backflow preventer </li> <li> White execution </li> <li> Top towing - the possibility of recirculation </li> <li> Controls - slider slider </li> <li> 3 levels of performance </li> <li> Max. Performance: 185 m3 / h. </li> <li> Max.hlučnost the highest level of 66 db (A) </li> <li> The bulb 40 W </li> <li> Textile grease filter </li> <li> diameter: 120 mm </li> </ul> <h2> Detailed description: </h2> <ul> <li> Optional Accessories: 1x textile filter 61990026, 1x carbon filter 61990028 </li> <li> 1 motor / fan </li> <li> Minimum distance from electric hob 650 mm </li> <li> Minimum distance from gas hob: 750 mm </li> <li> Net weight: 4 , 5 kg </li> <li> Voltage: 230 V ~ 50Hz </li> <li> Power: 150 W </li> <li> Cord Length: 1.5 m </li> </ul>',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '480 x 310 x 10 mm <br /> <br /> The filter is a need to adjust the scissors to cover the entire surface of the grease filter.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
            $productData->shortDescriptions[$domain->getId()] = t(
                '480 x 310 x 10 mm. The filter is a need to adjust the scissors to cover the entire surface of the grease filter.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'TS-9080 replacement bag for textile VP-9080',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Replacement textile bag for vacuum cleaners CONCEPT Sprinter - VP9070. Package: 1 pc',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'Cleaner 3in1 stainless steel appliances (4039286078461)',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Perfectly cleans, treats and protects stainless steel surfaces in one step.<ul> <li> <strong> remove </strong> without smudges dust, dirt, fingerprints and grease </li><li> long-lasting protective film <strong> repellent </strong> water and prevents new settling of dirt </li><li> <strong> acts </strong> antistatically </li></ul>',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->descriptions[$domain->getId()] = t(
                '295 x 245 x 15 mm <br /> cartridge with active carbon',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'TS-9170 replacement bag for textile VP-9171',
                [],
                'dataFixtures',
                $locale
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            $locale = $domain->getLocale();
            $productData->name[$locale] = t(
                'NS-9310 Infant replacement bags of paper for the VP-9310',
                [],
                'dataFixtures',
                $locale
            );
            $productData->descriptions[$domain->getId()] = t(
                'Spare paper bags for vacuum cleaners CONCEPT INFANT VP 9310th Package: 5 pieces of bags + 2.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'The printer uses ChromaLife100 ink system with four colors of ink hidden two print cartridges',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
        ...
        foreach ($this->domain->getAllIncludingDomainConfigsWithoutDataCreated() as $domain) {
            ...
            $productData->shortDescriptions[$domain->getId()] = t(
                'Easy printing, scanning and copying in one device will take much less space and you\'ll save money than buying individual components.',
                [],
                'dataFixtures',
                $domain->getLocale()
            );
    ...
    private function setCategoriesForAllDomains(ProductData $productData, array $categoryReferences): void
    {
        foreach ($this->domain->getAllIds() as $domainId) {
            foreach ($categoryReferences as $categoryReference) {
                $productData->categoriesByDomainId[$domainId][] = $this->persistentReferenceFacade->getReference(
                    $categoryReference
                );
            }
        }
    ...
    public function addProductReference(Product $product)
    {
        ...
        if (in_array(
            $product->getCatnum(),
            $this->getAllVariantCatnumsFromAssociativeArray(self::getVariantCatnumsByMainVariantCatnum()),
            true
        )) {
