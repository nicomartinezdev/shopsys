...
class ProductOnCurrentDomainElasticFacade implements ProductOnCurrentDomainFacadeInterface
{
    ...
    public function getPaginatedProductsForSearch(
        ...
        $filterQuery = $this->createListableProductsForSearchTextFilterQuery(
            $productFilterData,
            $orderingModeId,
            $page,
            $limit,
    ...
    public function getProductFilterCountDataInCategory(
        ...
        $baseFilterQuery = $this->filterQueryFactory->create($this->getIndexName())
            ...
            ->filterOnlyVisible($this->currentCustomerUser->getPricingGroup())
            ->filterByCategory([$categoryId]);
        $baseFilterQuery = $this->productFilterDataToQueryTransformer->addPricesToQuery(
            $productFilterData,
            $baseFilterQuery,
            $this->currentCustomerUser->getPricingGroup()
        );
        $baseFilterQuery = $this->productFilterDataToQueryTransformer->addStockToQuery(
            $productFilterData,
            $baseFilterQuery
        );
